...
- Improved code structure and internal consistency
- Added TypeScript types with clearer jsDocs
...
- ✔ Same behavior
- ✔ Same return values
- ✖ No algorithm changes yet (planned for v2)

## What’s Next (v2 Roadmap)
See ROADMAP_v2.md for details.
